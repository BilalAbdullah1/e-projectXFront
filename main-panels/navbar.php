...
<head>
    ...
    <link rel="img/tab-logo.png" href="favicon.ico" type="image/x-icon">
...
<body>
    ...
    <div class="container-fluid bg-primary text-white pt-4 pb-5 d-none d-lg-flex">
        <div class="container pb-2">         
            <div class= "logo">
            <img src="img/lab-logo.png" alt="error" width = "100px" height= "75px">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex">
    <div class="d-flex">
    <i class="bi bi-telephone-inbound fs-2" style="color: orange;"></i>


                    <div class="ms-2">
                        <h5 class="text-white ">Call Now</h5>
                        <h4><span>+012 345 6789</span></h4>
                    </Div>
      </form>
                    </div>
